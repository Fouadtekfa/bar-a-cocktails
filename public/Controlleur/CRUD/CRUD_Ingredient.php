...
<div class='d2'>
 ...
 <div id='navbarBasicExample' class='navbar-menu'>
   ...
   &nbsp;
   <center><h1 id='titre'>Liste des Ingredients</h1></center>&nbsp;
";
}
...
$message = "";
        ...
        $message .= "<center><p class='title is-4' id='titre2'>La table G07_Ingredient contient ".$nbingredient." enregistrements.</p></center>&nbsp\n";
        $contenu .="<div class='columns'>
        <div class='column is-1 '>
        </div>
        <div class='column '>
        <a href='../CRUD/Formulaire/formulaireIngredient.php?action=create' class='Arriere'>
        <input class='button is-fullwidth is-black is-outlined' type='submit' name='envoi' id='titr' value='Ajouter Ingredient'  />
        </a>
        </div>
        <div class='column is-1'>
        </div>
...
$lesingredients = $myPDOIngredient->getAll();
$contenu .= $vue->getAllIngredient($lesingredients);
echo getDebutHTML();
echo $message;
echo $contenu;
echo getFinHTML();
